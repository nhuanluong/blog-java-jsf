 ...
 */
package com.coursevm.web.blog.service;

import com.coursevm.entity.blog.test.InventoryStatus;
import com.coursevm.entity.blog.test.Product;
...
public class ProductService {
    ...
    public List<Product> getProducts() {
        ...
        products.add(new Product(1001, "nvklal433", "Black Watch", "Product Description", "black-watch.jpg", 72, "Accessories", 61, InventoryStatus.INSTOCK, 4));
